...
class UploadComponent extends Component
{
    ...
    */
    function __construct( ComponentCollection $collection, $options = null ) {
        ...
        $this->project_files = $this->UploadModel->find('list', array(
            'conditions' => array('project_id ' => $this->project_id),
            'fields' => array('name', 'id'),
        ));
        // var_dump($this->project_files);
    }
    ...
    protected function get_file_object($file_name) {
        ...
        if( is_file($file_path) && $file_name[0] !== '.' && array_key_exists($file_name, $this->project_files) ){
            $file = new stdClass();
            $file->name = $file_name;
            ...
            $file->created = date('m/d/Y h:i A', filectime($file_path));
...
/*
        $temp = $this->project_files = $this->UploadModel->find('all', array(
            'conditions' => array('project_id ' => $this->project_id),
        ));
